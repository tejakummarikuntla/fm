        ...
        <div className="pr-lg-4 mb-100">
          <div className="post-details-content">
            ...
            <p>
              ...
              content lead of AI at Udacity as well. He creates and maintains
              the serrano.academy, which aims to make the math and machine
              learning easy for every single data science aspirants in the
              world. Before His life into technology, he was a research
              mathematician and Ph.D. person from the University of Michigan. On
              top of all of that, he’s the author of{" "}
              <b>Grooking Machine Learning</b>. Currently, Luis is a Quantum AI
              Research scientist at Zapata computing.{" "}
            </p>
            ...
            <blockquote className="confer-blockquote">
              <h5>
                The question that I would like to ask myself all the time is,
                that was once asked to me, what would you do if all the jobs
                paid the same and ther's something in your mind and that's your
                passion.
              </h5>
            </blockquote>
            ...
            <div className="ticket-pricing-table-details">
              ...
              <p>
                <i className="zmdi zmdi-check"></i> How Machine learning
                distorts from academics to the industry?
              </p>
              <p>
                <i className="zmdi zmdi-check"></i> How to understand the
                research papers better?
              </p>
              <p>
            ...
            <p>
              ...
              coupon code during the purchase. On top of that Luis is Giving
              Away 5 Ebooks for completely free. Join the Giveaway challenge and
              get a chance to win a free copy of “Grokking Machine Learning”.
            </p>
            <p>
              Join the Giveaway challenge at
              <a
                target="_balnk"
                href="https://www.instagram.com/p/CCSnx-3nIjo/"
              >
                Instagram
              </a>{" "}
              or
